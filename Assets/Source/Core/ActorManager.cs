...
namespace DungeonCrawl.Core
{
    ...
    public class ActorManager : MonoBehaviour
    {
        ...
        private SpriteAtlas _harryAtlas;
        ...
        public List<Floo> GetFloos()
        {
            List<Floo> list = new List<Floo>();
            foreach (var actor in _allActors)
            {
                if (actor is Floo)
                {
        ...
        public Voldemort GetVoldemort()
        {
            foreach (var actor in _allActors)
            {
                if (actor is Voldemort)
                {
                    return (Voldemort)actor;
                }
            }
            return null;
        }
        private void Awake()
        {
            ...
            _harryAtlas = Resources.Load<SpriteAtlas>("HarrySheet");
        }
        ...
        public void DestroyActor(Actor actor)
        {
            ...
            UserInterface.Singleton.SetText(String.Empty, UserInterface.TextPosition.MiddleLeft);
        }
        ...
        public Sprite GetSprite(int id, bool isHarrySheet)
        {
            return _harryAtlas.GetSprite($"hp 1_{id}");
        }
